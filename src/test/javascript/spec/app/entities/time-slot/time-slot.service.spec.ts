    ...
    describe('TimeSlot Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/time-slots';
            ...
            it('should update a TimeSlot', () => {
                service.update(new TimeSlot(123)).subscribe(received => {
